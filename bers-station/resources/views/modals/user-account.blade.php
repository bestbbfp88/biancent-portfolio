    ...
    <div class="custom-modal-content">
        ...
        <form id="create-account-form" class="create-account-form">
            ...
            <div class="form-group">
                ...
                <input type="number" id="phone" placeholder="+63xxxxxxxxxx" name="phone" required>
                    ...
                    <div id="update_station-fields-container" style="display: none;">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-2">
                                <input type="text" class="form-control" id="update_address" name="address" placeholder="Enter Station Address" readonly>
