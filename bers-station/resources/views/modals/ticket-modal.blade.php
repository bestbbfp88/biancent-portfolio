                            ...
                            <div class="row"> 
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="emergencyType" disabled>
                                            ...
                                            <div id="mvcSubOptions" class="mt-2" style="display: none;">
                                                ...
                                                <input class="form-check-input" type="radio" name="mvcType" id="mvcExtrication" value="For Extrication" disabled>
                                                <label class="form-check-label" for="mvcExtrication">For Extrication</label>
                                                </div>
                                                <div class="form-check">
                                                <input class="form-check-input" type="radio" name="mvcType" id="mvcNonExtrication" value="Not For Extrication" disabled>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">🚑 Emergency Responder Station</label>
                                                <div class="dropdown">
                                                    <button class="btn btn-light dropdown-toggle w-100" type="button" id="stationDropdownButton" data-bs-toggle="dropdown" aria-expanded="false" disabled>
                                                        -- Select Station(s) --
                                                    </button>
                                                    <ul class="dropdown-menu w-100" id="stationDropdownMenu" disabled>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3"  id="tarsierResponderSection" style="display: none;">
                                                <label class="form-label">Select Available Responder</label>
                                                <div class="dropdown">
                                                    <button class="btn btn-light dropdown-toggle w-100" type="button" id="responderDropdownButton" data-bs-toggle="dropdown" aria-expanded="false">
                                                        -- Select TaRSIER Responder(s) --
                                                    </button>
                                                    <ul class="dropdown-menu w-100" id="responderDropdownMenu">
