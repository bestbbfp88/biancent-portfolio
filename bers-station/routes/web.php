...
Route::middleware([RedirectIfAuthenticated::class])->group(function () {
    ...
    Route::post('/emergency-responder-station/login', [AdminAuthController::class, 'login']);
});
...
Route::middleware([FirebaseAuthMiddleware::class, EnsureEmailIsVerified::class])->group(function () {
    Route::get('/emergency-responder-station/dashboard', [AdminAuthController::class, 'dashboard'])->name('admin.dashboard');
});



Route::post('/api/emergency-responder-station/create-user', [roleCreateAccountController::class, 'createUserByAdmin']);
...
Route::post('/emergency-responder-station/password-reset/{id}', [activeAccountsController::class, 'sendPasswordReset']);
