...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    addHospitalForm.addEventListener("submit", async function (event) {
        ...
        const rawHospitalName = hospitalNameInput.value.trim();
        ...
        const addressFeedback = document.getElementById("hospitalAddressFeedback")
        ...
        console.log("🏥 Hospital Address Element:", hospitalAddressInput);
        console.log("🏥 Hospital Address Value:", hospitalAddressInput.value.trim());

        if (!hospitalAddressInput.value.trim()) {
            console.log("⚠️ Hospital address is empty");
            hospitalAddressInput.classList.add("is-invalid");
            addressFeedback.textContent = "Hospital address is required.";
            addressFeedback.style.display = 'block';
            valid = false;
        } else {
            console.log("✅ Hospital address entered:", hospitalAddressInput.value.trim());
            hospitalAddressInput.classList.remove("is-invalid");
