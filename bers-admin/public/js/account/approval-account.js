document.addEventListener("DOMContentLoaded", function () {
            ...
            let row = `
                <tr data-user-id="${user.id}">
                    ...
                    <td style="display: flex; gap: 10px; ">
                        <button class="btn btn-success approval-btn-user" data-key="${user.id}">Approve</button>
                        <button class="btn btn-danger reject-btn-user" data-key="${user.id}">Reject</button>
                    </td>
                </tr>
            `;
    ...
    function showRejectModal() {
        ...
        setTimeout(() => {
            successRejectModal.style.display = "none";
        }, 2000);
    }
