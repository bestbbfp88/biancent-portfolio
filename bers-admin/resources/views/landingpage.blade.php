...
<head>
    ...
    <script src="{{ asset('js/essentials/by_role.js') }}" defer></script>  
...
<!-- SmoothMarkerBouncing (CDN) -->
    ...
    <script src="{{ asset('js/account/notification_status.js') }}"></script>  
    <script type="module" src="/js/account/location_picker.js"></script>
    ...
    <script src="{{ asset('js/hospital/create-hospital.js') }}"></script>   
    <script src="{{ asset('js/hospital/active-hospital.js') }}"></script>  
    <script src="{{ asset('js/hospital/deactivated-hospital.js') }}"></script> 

    <script src="{{ asset('js/emergency_number/create-number.js') }}"></script>
    <script src="{{ asset('js/emergency_number/active-emergency_number.js') }}"></script>  
    <script src="{{ asset('js/emergency_number/deactivated-emergency_number.js') }}"></script>

    <script src="{{ asset('js/request-emergency/emergency-request.js') }}"></script>
    <script src="{{ asset('js/request-emergency/ambulance.js') }}"></script>


    <script src="{{ asset('js/personnel-emergency/emergency-personnel.js') }}"></script>
    <script src="{{ asset('js/personnel-emergency/fetch_stations.js') }}"></script>
...
<body class="h-screen flex bg-gray-100">
    ...
    <div id="sidebar" class="sidebar">
        <div class="sidebar-header">
            <h5> <i class="fas fa-users-cog"></i> Admin Panel</h5>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link" data-bs-toggle="modal" data-bs-target="#hospitalModal">
                    <i class="fas fa-hospital"></i> Hospital
                </a>
            </li>

            <li class="nav-item">
                <a href="#" class="nav-link" data-bs-toggle="modal" data-bs-target="#emergencyModalEmNumber">
    ...
    <div class="main-content">
        <!-- ✅ Top Bar -->
        <div class="top-bar d-flex align-items-center justify-content-between" id="topBar">
             ...
             <div class="d-flex align-items-center">
                ...
                <div class="me-3">
                    <button id="createTicketLanding" class="create-ticket-btn" onclick="openNewTicketModal()">
                        <i class="fas fa-plus-circle me-1"></i> Create Ticket
                    </button>
                </div>
                
                <div class="dropdown me-3" id="notificationContainer" >
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow" id="notificationList" style="z-index: 10000;"
            ...
            <!-- ✅ New Title for Top Navigation -->
            <h1 class="top-title">Bohol Emergency Response System</h1>

            <div class="filter-menu-container">
                <button class="btn filter-menu-btn dropdown-toggle" type="button" id="stationFilterDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    🛠 Filters
                </button>
                
                <ul class="dropdown-menu filter-menu-dropdown dropdown-menu-end" aria-labelledby="stationFilterDropdown">
                    
                  <!-- 📍 Station Filters -->
                    <li><h6 class="filter-menu-header">📍 Station Filters</h6></li>
                    <li class="px-3 py-1 d-flex justify-content-between align-items-center">
                        <span>LGU Stations</span>
                        <div class="form-check form-switch m-0">
                            <input class="form-check-input filter-menu-switch" type="checkbox" id="stationToggleSwitch">
                        </div>
                    </li>
                    <li class="px-3 py-1 d-flex justify-content-between align-items-center">
                        <span>TaRSIER Units</span>
                        <div class="form-check form-switch m-0">
                            <input class="form-check-input filter-menu-switch" type="checkbox" id="tarsierToggleSwitch">
                        </div>
                    </li>

                    <li><hr class="filter-menu-divider"></li>

                    <!-- 🚨 Responder Filters -->
                    <li><h6 class="filter-menu-header">🚨 Responder Filters</h6></li>
                    <li class="px-3 py-1 d-flex justify-content-between align-items-center">
                        <span>LGU Responders</span>
                        <div class="form-check form-switch m-0">
                            <input class="form-check-input filter-menu-switch" type="checkbox" id="responderToggleSwitch">
                        </div>
                    </li>
                    <li class="px-3 py-1 d-flex justify-content-between align-items-center">
                        <span>TaRSIER Responders</span>
                        <div class="form-check form-switch m-0">
                            <input class="form-check-input filter-menu-switch" type="checkbox" id="tarsierResponderToggleSwitch">
                        </div>
                    </li>
            ...
            <div class="dropdown" id="profileDropdownContainer">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow text-wrap" aria-labelledby="profileDropdown"
                    ...
                    <li class="px-3 pt-2">
                        ...
                        <div class="small mt-2"><strong>🎂 Birthdate:</strong> <br> <span id="dropdownProfileBirthdate"></span></div>
                        <div class="small mt-2"><strong>🧑 Gender:</strong> <br> <span id="dropdownProfileGender"></span></div>
                    </li>
    ...
    <div id="mapLegend" class="map-legend">
        ...
        <div><span class="legend-circle" style="background-color: #e60000;"></span> Pending</div>
        <div><span class="legend-circle" style="background-color: #007bff;"></span> PNP (Police)</div>
        <div><span class="legend-circle" style="background-color: #dc3545;"></span> BFP (Fire)</div>
        <div><span class="legend-circle" style="background-color: #28a745;"></span> MDRRMO</div>
        <div><span class="legend-circle" style="background-color: #fd7e14;"></span> Coast Guard</div>
        <div><span class="legend-circle" style="background-color: #0e1a73;"></span> TaRSIER</div>
        <div><span class="legend-circle" style="background-color: #6c757d;"></span> No Responder</div>
    </div>
