    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addResponderUnitForm">
          ...
          <div class="mb-3">
            <label for="unitAssign" class="form-label">Unit Assignment</label>
            <select class="form-select" id="unitAssign" required>
          ...
          <div class="mb-3" id="erStationGroup">
            <label for="erStation" class="form-label">Emergency Responder Station</label>
            <select class="form-select" id="erStation" required>
