...
<div class="modal fade" id="responderPersonnelModal" tabindex="-1" aria-labelledby="responderPersonnelLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 70vh; display: flex; flex-direction: column;">
                ...
                <!-- Table -->
                  <div class="table-responsive" style="overflow-y: auto; flex-grow: 1; min-height: 200px;">
      ...
      <div class="modal-body">
        <form id="addResponderForm">
          ...
          <div class="mb-3">
            ...
            <input type="tel" class="form-control" id="responderContact" name="responderContact" placeholder="+63xxxxxxxxxx" required>
            <div class="invalid-feedback" id="phoneError">Please enter a valid phone number in +63 format.</div>
          </div>


          <div class="mb-3" id="responderCreatedForDiv">
            <label for="responderCreatedFor" class="form-label">
              Created For 
              <span class="text-muted">(Leave blank if creating for TaRSIER)</span>
            </label>
            <select class="form-select" id="responderCreatedFor">
              <option value="" disabled selected>Select station</option>
            </select>
            <input type="hidden" id="selectedStationUID" name="selectedStationUID">
          </div>
